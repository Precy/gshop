...
export const  RECEIVE_GOODS = 'receive_goods' //接收商品列表数组
export const  RECEIVE_INFO = 'receive_info'// 接收商家信息
export const  RECEIVE_RATINGS = 'receice_ratings'//接收评价信息数组
...
export const  RECEIVE_SEARCHSHOPS = 'receive_searchShops' //接收商家数组
